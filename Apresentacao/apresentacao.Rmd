...
> Estimar o efeito impacto da Greve da PM na taxa de homicídios do Estado - Quanto da variação nos homicídios é atribuível ao evento?

* Estatísticas de homicídios são comumente reportadas em "número de homicídios/100 mil habitantes/ano". Os modelos serão estimados em taxa de homicídios por dia, já que essa transformação trouxe melhores resultados em termos de fit.
...
* Portanto, observamos um aumento estimado de 62% no número de homicídios para o período.
